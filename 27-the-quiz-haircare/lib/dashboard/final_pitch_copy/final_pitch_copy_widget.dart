...
class FinalPitchCopyWidget extends StatefulWidget {
  const FinalPitchCopyWidget({
    super.key,
  ...
  @override
  State<FinalPitchCopyWidget> createState() => _FinalPitchCopyWidgetState();
}

class _FinalPitchCopyWidgetState extends State<FinalPitchCopyWidget> {
  late FinalPitchCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FinalPitchCopyModel());
                    ...
                    children: [
                      Padding(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(
                            'https://cdn.prod.website-files.com/62cbaa353a301eb715aa33d0/64a5414de6dfbabc3f147dba_Before-after-good-routine_Pauline_LD-p-500.jpg',
                                        ...
                                        child: Container(
                                          ...
                                          child: Slider(
                                            activeColor:
                                                FlutterFlowTheme.of(context)
                                                    .redColor,
                                            inactiveColor: Color(0x6DAB0018),
                                            min: 0.0,
                                            max: 100.0,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Container(
                                          decoration: BoxDecoration(),
                                          child: wrapWithModel(
                                            model: _model.dashboardWidgetModel5,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: DashboardWidgetWidget(
                                              header: 'Confidence',
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: Container(
                                          decoration: BoxDecoration(),
                                          child: wrapWithModel(
                                            model: _model.dashboardWidgetModel6,
                                            updateCallback: () =>
                                                safeSetState(() {}),
                                            child: DashboardWidgetWidget(
                                              header: 'Haircare routine',
                                        ...
                                        child: Container(
                                          ...
                                          child: Slider(
                                            activeColor:
                                                FlutterFlowTheme.of(context)
                                                    .secondaryPlum,
                                            inactiveColor: Color(0xB3B1BAE3),
                                            min: 0.0,
                                            max: 100.0,
                                            value: _model.sliderValue2 ??= 85.0,
                                            onChanged: (newValue) {
                                              newValue = double.parse(
                                                  newValue.toStringAsFixed(2));
                                              safeSetState(() => _model
                            ...
                            itemBuilder: (context, planDataIndex) {
                              ...
                              return Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    _model.selctedValue = planDataIndex;
                                    safeSetState(() {});
                                  },
                                  child: ClipRRect(
                                                          ...
                                                          children: [
                                                            Row(
                                                              ...
                                                              children: [
                                                                Padding(
                                                                  padding: EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                                  child: Text(
                                                                    '\$${planDataItem.actualPrice.toString()}',
                                                                ...
                                                                Text(
                                                                  '\$${planDataItem.discountedPrice.toString()}',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodyMedium
                                                                      .override(
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    '\$${planDataItem.perDayActualPrice.toString()}',
                                                                    style: FlutterFlowTheme.of(
                                                                            context)
                                                                        .bodyMedium
                                                                        .override(
