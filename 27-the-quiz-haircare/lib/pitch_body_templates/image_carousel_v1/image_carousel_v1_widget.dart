...
class ImageCarouselV1Widget extends StatefulWidget {
  const ImageCarouselV1Widget({
    super.key,
  ...
  @override
  State<ImageCarouselV1Widget> createState() => _ImageCarouselV1WidgetState();
}

class _ImageCarouselV1WidgetState extends State<ImageCarouselV1Widget> {
  late ImageCarouselV1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ImageCarouselV1Model());
