...
class FloatingTimerDialogBoxWidget extends StatefulWidget {
  const FloatingTimerDialogBoxWidget({super.key});

  @override
  State<FloatingTimerDialogBoxWidget> createState() =>
      _FloatingTimerDialogBoxWidgetState();
}

class _FloatingTimerDialogBoxWidgetState
    extends State<FloatingTimerDialogBoxWidget> {
  late FloatingTimerDialogBoxModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FloatingTimerDialogBoxModel());
                  ...
                  builder: (context) => Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        FFAppState().timerSecElapsed = _model.timerMilliseconds;
                        safeSetState(() {});
                        await showDialog(
                          context: context,
