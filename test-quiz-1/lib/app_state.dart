...
class FFAppState extends ChangeNotifier {
  ...
  List<ImageAnswerStruct> _hairConcern = [
    ...
    ImageAnswerStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/Q3%20other.webp\",\"answer\":\"Andere, diverse Probleme\",\"id\":\"concern_mixed\",\"type\":\"hairConcern\"}'))
  ];
  ...
  List<AnswerStruct> _hairGoal = [
    AnswerStruct.fromSerializableMap(jsonDecode(
        '{\"answer\":\"Weniger Haarausfall\",\"image\":\"https://assets.hairqare.co/mid-hairloss-graphic.webp\",\"id\":\"goal_hairloss\",\"type\":\"hairGoal\"}')),
    AnswerStruct.fromSerializableMap(jsonDecode(
        '{\"answer\":\"Längeres, schöneres Haar\",\"image\":\"https://assets.hairqare.co/mid-hair-graphic.webp\",\"id\":\"goal_betterhair\",\"type\":\"hairGoal\"}')),
    AnswerStruct.fromSerializableMap(jsonDecode(
  ...
  List<ImageAnswerStruct> _hairType = [
    ...
    ImageAnswerStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/Q1-Not%20Sure.webp\",\"answer\":\"Keine Ahnung\",\"id\":\"hairType_unknown\",\"type\":\"hairType\"}'))
  ];
  ...
  List<AnswerStruct> _knowledgeState = [
    AnswerStruct.fromSerializableMap(jsonDecode(
        '{\"answer\":\"🙌 Ja, aber ich brauche etwas Hilfe\",\"image\":\"\",\"id\":\"knowledge_yes\",\"type\":\"knowledgeState\"}')),
    AnswerStruct.fromSerializableMap(jsonDecode(
        '{\"answer\":\"😢 Nein, und ich hab echt keine Lust mehr zu suchen\",\"image\":\"\",\"id\":\"knowledge_no\",\"type\":\"knowledgeState\"}')),
    AnswerStruct.fromSerializableMap(jsonDecode(
        '{\"answer\":\"😥 Keine Ahnung, alleine ist das kompliziert\",\"image\":\"\",\"id\":\"knowledge_notsure\",\"type\":\"knowledgeState\"}'))
  ];
  ...
  List<ImageAnswerStruct> _hairqareKnowledge = [
    ImageAnswerStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/emoji-1.webp\",\"answer\":\"Höre ich zum ersten Mal\",\"id\":\"hairqare_unknown\",\"type\":\"hairqare\"}')),
    ImageAnswerStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/emoji-3.webp\",\"answer\":\"Habe schonmal davon gehört\",\"id\":\"hairqare_notunknown\",\"type\":\"hairqare\"}')),
    ImageAnswerStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/emoji-2.webp\",\"answer\":\"Ich bin sehr informiert\",\"id\":\"hairqare_familiar\",\"type\":\"hairqare\"}'))
  ];
  ...
  List<ImageAnswerStruct> _diet = [
    ImageAnswerStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/Mostly%20unhealthy%20diet.webp\",\"answer\":\"Fast food / Fertigprodukte\",\"id\":\"diet_processed\",\"type\":\"diet\"}')),
    ImageAnswerStruct.fromSerializableMap(jsonDecode(
  ...
  List<AnswerWithAdditionalInfoStruct> _shampooSpending = [
    AnswerWithAdditionalInfoStruct.fromSerializableMap(jsonDecode(
        '{\"answer\":\"Weniger als €10\",\"image\":\"https://assets.hairqare.co/Less%20than%20%2410.webp\",\"AnswerTitle\":\"Mega! 🤩 Du achtest aufs Geld!\",\"AnswerDescription\":\"You can actually have amazing results without spending more than you do now (or even less) while avoiding harmful products that secretly ruin your hair. You just need the right routine for your unique situation.\",\"id\":\"spend_under10\",\"type\":\"shampooSpending\"}')),
    AnswerWithAdditionalInfoStruct.fromSerializableMap(jsonDecode(
        '{\"answer\":\"€10 - €20\",\"image\":\"https://assets.hairqare.co/%2410%20-%20%2420.webp\",\"AnswerTitle\":\"Amazing 🙌 you value your hair!\",\"AnswerDescription\":\"Du gibst dein Geld überlegt aus, aber zahlst wahrscheinlich trotzdem mehr fürs Marketing als für echte Ergebnisse.\\n\\nMit der richtigen Routine bekommst du endlich wirklich spürbare Veränderungen – genau auf dich und deine Haare abgestimmt – und das, ohne mehr auszugeben.\",\"id\":\"spend_10to20\",\"type\":\"shampooSpending\"}')),
    AnswerWithAdditionalInfoStruct.fromSerializableMap(jsonDecode(
        '{\"answer\":\"€20 - €50\",\"image\":\"https://assets.hairqare.co/%2420-%2450.webp\",\"AnswerTitle\":\"You clearly care about your hair 💜\",\"AnswerDescription\":\"Wusstest du, dass bei teuren Haarpflege-Produkten bis zu 90 % vom Preis nur für Verpackung und Marketing draufgehen – und nicht für die Inhaltsstoffe?\\n\\nMit der richtigen Routine bekommst du echte Premium-Ergebnisse, ganz ohne den hohen Preis.\",\"id\":\"spend_20to50\",\"type\":\"shampooSpending\"}')),
    AnswerWithAdditionalInfoStruct.fromSerializableMap(jsonDecode(
        '{\"answer\":\"Mehr als €50\",\"image\":\"https://assets.hairqare.co/More%20than%20%2450.webp\",\"AnswerTitle\":\"Your hair deserves the best ✨\",\"AnswerDescription\":\"Did you know premium haircare often uses the same ingredients as budget options? With the right personalized routine, you can actually achieve the results those luxury brands are just promising.\",\"id\":\"spend_over50\",\"type\":\"shampooSpending\"}'))
  ];
  ...
  List<MultiChoiceWithImagesCheckBoxStruct> _hairMyth = [
    ...
    MultiChoiceWithImagesCheckBoxStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/Coconut%20Oil.webp\",\"title\":\"Kokosöl ist das beste Haaröl\",\"checklBox\":\"false\",\"Id\":\"myth_coconut\",\"type\":\"hairMyth\"}')),
    MultiChoiceWithImagesCheckBoxStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/Rice%20Water.webp\",\"title\":\"Mit Reiswasser wachsen deine Haare schneller\",\"checklBox\":\"false\",\"Id\":\"myth_ricewater\",\"type\":\"hairMyth\"}')),
    MultiChoiceWithImagesCheckBoxStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/Natural.webp\",\"title\":\"Natürliche oder Bio-Produkte sind besser\",\"checklBox\":\"false\",\"Id\":\"myth_organic\",\"type\":\"hairMyth\"}')),
    MultiChoiceWithImagesCheckBoxStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/Not%20Washing.webp\",\"title\":\"Haare nicht waschen, ist gut für die Kopfhaut\",\"checklBox\":\"false\",\"Id\":\"myth_nopoo\",\"type\":\"hairMyth\"}'))
  ];
  ...
  List<MultiChoiceWithImagesCheckBoxStruct> _hairDamageActivity = [
    MultiChoiceWithImagesCheckBoxStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/heat.webp\",\"title\":\"Styling mit Hitze\",\"checklBox\":\"false\",\"Id\":\"damageAction_heat\",\"type\":\"hairDamageActivity\"}')),
    MultiChoiceWithImagesCheckBoxStruct.fromSerializableMap(jsonDecode(
        '{\"image\":\"https://assets.hairqare.co/dye.webp\",\"title\":\"Blondieren / Haare färben\",\"checklBox\":\"false\",\"Id\":\"damageAction_dye\",\"type\":\"hairDamageActivity\"}')),
    MultiChoiceWithImagesCheckBoxStruct.fromSerializableMap(jsonDecode(
  ...
  List<AnswerStruct> _professionalReferral = [
    ...
    AnswerStruct.fromSerializableMap(jsonDecode(
        '{\"answer\":\"Ich bin selbst von Fach\",\"image\":\"\",\"id\":\"professional_self\",\"type\":\"professionalReferral\"}'))
  ];
  ...
  List<AnswerWithTitleAndDescriptionStruct> _currentRoutine = [
    AnswerWithTitleAndDescriptionStruct.fromSerializableMap(jsonDecode(
        '{\"title\":\"🤓 Advanced\",\"description\":\"Salons, premium Produkte, experten Hilfe, Nahrungsergänzungsmittel\",\"id\":\"routine_complex\",\"type\":\"currentRoutine\"}')),
    AnswerWithTitleAndDescriptionStruct.fromSerializableMap(jsonDecode(
        '{\"title\":\"🫧 Einfache Routine\",\"description\":\"Meistens nur Shampoo und Spülung\",\"id\":\"routine_basic\",\"type\":\"currentRoutine\"}')),
    AnswerWithTitleAndDescriptionStruct.fromSerializableMap(jsonDecode(
        '{\"title\":\"🤗 Gelegentliches Haar-Verwöhnprogramm\",\"description\":\"Meistens einfache Pflege, hin und wieder mehr\",\"id\":\"routine_intermediete\",\"type\":\"currentRoutine\"}')),
    AnswerWithTitleAndDescriptionStruct.fromSerializableMap(jsonDecode(
        '{\"title\":\"🌿 Natürliche Hausmittel\",\"description\":\"Vor allem Öle, Kräuter oder selbstgemachte Produkte\",\"id\":\"routine_natural\",\"type\":\"currentRoutine\"}')),
    AnswerWithTitleAndDescriptionStruct.fromSerializableMap(jsonDecode(
        '{\"title\":\"😌 None of the above\",\"description\":\"Ich mache etwas Anderes für meine Haare\",\"id\":\"routine_other\",\"type\":\"currentRoutine\"}'))
  ];
  ...
  // ============================================================
  // QUIZ V2 STATE PROPERTIES
  // ============================================================

  /// Flag to enable Quiz V2 flow (for A/B testing or migration)
  bool _isQuizV2Active = true;
  bool get isQuizV2Active => _isQuizV2Active;
  set isQuizV2Active(bool value) {
    _isQuizV2Active = value;
  }

  /// Current screen index in Quiz V2 (0-23)
  int _currentScreenIndexV2 = 0;
  int get currentScreenIndexV2 => _currentScreenIndexV2;
  set currentScreenIndexV2(int value) {
    _currentScreenIndexV2 = value;
  }

  /// Progress bar step for display (1-12) - only shown on question screens
  int _progressBarStepV2 = 1;
  int get progressBarStepV2 => _progressBarStepV2;
  set progressBarStepV2(int value) {
    _progressBarStepV2 = value;
  }

  /// Main Quiz V2 profile containing all user answers and calculations
  QuizProfileV2Struct _quizProfileV2 = QuizProfileV2Struct();
  QuizProfileV2Struct get quizProfileV2 => _quizProfileV2;
  set quizProfileV2(QuizProfileV2Struct value) {
    _quizProfileV2 = value;
  }

  /// Update specific fields in the quiz profile
  void updateQuizProfileV2(Function(QuizProfileV2Struct) updateFn) {
    updateFn(_quizProfileV2);
    notifyListeners();
  }

  /// Reset Quiz V2 to initial state
  void resetQuizV2() {
    _currentScreenIndexV2 = 0;
    _progressBarStepV2 = 1;
    _quizProfileV2 = QuizProfileV2Struct();
    notifyListeners();
  }

  /// Navigate to next screen in Quiz V2
  void nextScreenV2() {
    _currentScreenIndexV2++;
    notifyListeners();
  }

  /// Navigate to previous screen in Quiz V2
  void previousScreenV2() {
    if (_currentScreenIndexV2 > 0) {
      _currentScreenIndexV2--;
      notifyListeners();
    }
  }

  /// Go to specific screen in Quiz V2
  void goToScreenV2(int screenIndex) {
    _currentScreenIndexV2 = screenIndex;
    notifyListeners();
  }

  /// List of testimonials for V2 matching
  List<TestimonialV2Struct> _testimonialsV2 = [];
  List<TestimonialV2Struct> get testimonialsV2 => _testimonialsV2;
  set testimonialsV2(List<TestimonialV2Struct> value) {
    _testimonialsV2 = value;
  }

  void addToTestimonialsV2(TestimonialV2Struct value) {
    testimonialsV2.add(value);
  }

  void removeFromTestimonialsV2(TestimonialV2Struct value) {
    testimonialsV2.remove(value);
  }
}
