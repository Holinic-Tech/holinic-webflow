...
function handleDataSubmission (email, firstName, lastName, answers) {
    ...
    var redirectUrl = 'https://cart.hairqare.co/14-day-haircare-challenge?discount=save-85&__cvg_uid=' + cvgUid + '&billing_email=' + encodeURIComponent(email) + '&billing_first_name=' + encodeURIComponent(firstName) + '&billing_last_name=' + encodeURIComponent(lastName);
