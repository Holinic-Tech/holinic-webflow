// worker-v2.js - Updated Cloudflare Worker with Webflow Folder Support
...
async function translatePage(page, targetLanguage, env) {
  ...
  try {
    ...
    const languageFolderId = await getOrCreateLanguageFolder(targetLanguage, env.WEBFLOW_TOKEN, env.WEBFLOW_SITE_ID);
